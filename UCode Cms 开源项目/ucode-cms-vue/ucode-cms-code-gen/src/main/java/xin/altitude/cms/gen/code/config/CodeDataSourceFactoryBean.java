...
public class CodeDataSourceFactoryBean implements FactoryBean<DataSource> {
    ...
    public DataSource getObject() {
        HikariDataSource defaultDruidDataSource = new HikariDataSource();
        BeanUtils.copyProperties(dataSourceProperties, defaultDruidDataSource);
        defaultDruidDataSource.setJdbcUrl(dataSourceProperties.getUrl());
        if (enabled) {
            HikariDataSource codeDruidDataSource = new HikariDataSource();
            codeDruidDataSource.setJdbcUrl(url);
