...
public class DomainService extends CommonService {
    ...
    public void writeToLocalFile(String tableName, String className) {
        ...
        String parentDirPath = CodeUtils.createRelativJavaDirFilePath("domain");
    ...
    public List<String> getImportList() {
        ...
        if (config.getDomain().getAddImportList()) {
            ...
            if (config.getDomain().getUseLombok()) {
            ...
            if (DaoEnum.mybatisPlus.equals(config.getDao()) && config.getMapper().getUseCache()) {
