 ...
 **/
// @Service
public class MapStructService extends CommonService implements IMapperService {
    private final static String TEMPLATE = "vm10/java/mapStruct.java.vm";

    @Override
    public void writeToLocalFile(String tableName, String className) {
        String fileName = String.format("%sMapStruct.java", className);
        String value = realtimePreview(tableName);
        String parentDirPath = CodeUtils.createRelativJavaDirFilePath("mapstruct");
